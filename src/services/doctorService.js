        ...
        try {
            ...
            if (checkObj.isValid === false) {
                ...
                if (inputData.action === "CREATE") {
                    ...
                    if (doctorMarkdown) {
                        console.log('anh pham check ', doctorMarkdown)
    ...
    return new Promise(async (resolve, reject) => {
        try {
            if (!inputId) {
                ...
                console.log('check data extra', data)
            }
    ...
    return new Promise(async (resolve, reject) => {
        try {
            if (!data.arrSchedule || !data.doctorId || !data.formatedDate) {
                ...
                console.log('anh pham check data send', schedule)

                //get all exising data
                ...
                let toCreate = _.differenceWith(schedule, existing, (a, b) => {
                    return a.timeType === b.timeType && a.date === b.date && +a.date === +b.date;
                })
...
let getScheduleByDate = (doctorId, date) => {
    return new Promise(async (resolve, reject) => {
        try {
            console.log('doctorId check', doctorId)
            if (!doctorId || !date) {
                resolve({
                    errCode: 1,
                    errMessage: 'Missing required parameter'
